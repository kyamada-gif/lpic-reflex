...
const QUESTIONS = [{
  ...
  "source": "想定",
  "type": "single",
  "question": "ハードリンクとシンボリックリンクの違いとして誤っているものはどれか",
  "choices": [{
    "label": "A",
    "text": "ハードリンクはディレクトリに対しても作成できる"
  }, {
  ...
  "answer": ["B"],
  "selectCount": 1,
  "identifyHint": "ハードリンクとシンボリックリンクの違いとして誤っているもの",
  "decisionKey": "",
  "mnemonic": "",
  "answerKeys": ["ハードリンクとシンボリックリンクの違いとして誤っているものはどれか"],
  "answerTexts": ["ハードリンクはファイルシステムをまたげるが、シンボリックリンクはまたげない"],
  "answerHints": ["ハードリンクはファイルシステム"],
  "chap": "第5章 デバイスとLinuxファイルシステム"
}, {
  "id": 279,
  "source": "想定",
  ...
  "answer": ["A"],
  "selectCount": 1,
  "identifyHint": "ハードリンクとシンボリックリンクの違いとして誤っている",
  "decisionKey": "",
  "mnemonic": "",
  "answerKeys": ["ハードリンクとシンボリックリンクの違いとして誤っているものはどれか。"],
  "answerTexts": ["ハードリンクはディレクトリに対しても作成できる"],
  "answerHints": ["ハードリンクはディレクトリ"],
  "chap": "第5章 デバイスとLinuxファイルシステム"
}, {
  "id": 100060,
  "source": "想定",
